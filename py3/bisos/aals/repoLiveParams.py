...
"""
*  This file:/bisos/git/auth/bxRepos/bisos-pip/aals/py3/bisos/aals/repoLiveParams.py :: [[elisp:(org-cycle)][| ]]
...
####+END:
        ...
        self.fpsBaseInst = AalsRepo_LiveParams_FPs(self.fps_absBasePath())
...
####+BEGIN: bx:dblock:python:class :className "AalsRepo_LiveParams_FPs" :superClass "fp.FP_Base" :comment "Expected to be subclassed" :classType "basic"
"""
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Class-basic :: /AalsRepo_LiveParams_FPs/ fp.FP_Base =Expected to be subclassed=  [[elisp:(org-cycle)][| ]]
"""
class AalsRepo_LiveParams_FPs(fp.FP_Base):
####+END:
...
####+END:
        ...
        return (
            {
                'aalsPlatformBpoId': relBasePath,
                'aalsPlatformIpAddr': relBasePath,

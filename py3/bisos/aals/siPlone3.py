...
** TODO siInvoke and method parameter and siInvoke should be moved to aaisBpo module
**      [End-Of-Status]
"""
...
"""
*  This file:/bisos/git/auth/bxRepos/bisos-pip/aais/py3/bisos/aais/siPlone3.py :: [[elisp:(org-cycle)][| ]]
...
####+END:
        ...
        svcProvBaseDir = aaisBpo.si_svcBaseDir(bpoId, si)
...
####+BEGIN: bx:dblock:python:class :className "SiRepo_Plone3" :superClass "aaisBpo.SiRepo" :comment "Expected to be subclassed" :classType "basic"
"""
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Class-basic :: /SiRepo_Plone3/ aaisBpo.SiRepo =Expected to be subclassed=  [[elisp:(org-cycle)][| ]]
"""
class SiRepo_Plone3(aaisBpo.SiRepo):
####+END:
    """
...
####+BEGIN: bx:dblock:python:class :className "Plone3_Inst" :superClass "aaisBpo.SiSvcInst" :comment "Expected to be subclassed" :classType "basic"
"""
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Class-basic :: /Plone3_Inst/ aaisBpo.SiSvcInst =Expected to be subclassed=  [[elisp:(org-cycle)][| ]]
"""
class Plone3_Inst(aaisBpo.SiSvcInst):
####+END:
    """
** Abstraction of the base ByStar Portable Object
"""
...
####+END:
    ...
    aaisBpo.createSiObj(bpoId, siRepoBase, SiRepo_Plone3)
...
####+END:
    ...
    thisSi = aaisBpo.createSiObj(bpoId, siRepoBase, Plone3_Inst)
